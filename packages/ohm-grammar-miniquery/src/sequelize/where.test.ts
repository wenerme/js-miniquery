...
import { DataTypes, FindOptions, Includeable, ModelStatic, Sequelize, WhereOptions } from '@sequelize/core';
...
test.before(async (t) => {
  ...
  let Department = await sequelize.define(
    'Department',
    {
      fullName: {
        type: DataTypes.STRING,
  ...
  let Profile = await sequelize.define(
    'Profile',
    {
      name: {
        type: DataTypes.STRING,
  ...
  let Pet = await sequelize.define(
    'Pet',
    {
      fullName: {
        type: DataTypes.STRING,
  ...
  let Image = await sequelize.define(
    'Image',
    {
      imageUrl: {
        type: DataTypes.STRING,
